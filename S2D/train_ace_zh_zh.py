...
parser.add_argument('--config', default='/media/h3c/users/zongkai/LAPIN/config-large/config_ace05_mT5copy-base_en_ar_prompt_distance.json')
# parser.add_argument('--output_dir', type=str, default='../output/ace05_mT5copy-base_en/20220608_045935/ar')
